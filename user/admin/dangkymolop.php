...
$from = ($trang - 1) * $sotin;
// tổng số trang tin
$select = "SELECT * FROM `hocvien` WHERE DK_LOP = 1 order by ID_HOCVIEN DESC";
                        ...
                        <tbody>
                            ...
                            while ($row = mysql_fetch_array($qr)) {
                                ...
                                <tr class="table-row">
                                    ...
                                    <td class="table-text">
                                        <h6><?php                                         
                                        echo ten_mh($row['DK_MON']);?></h6>                                                                
                                    </td>  

                                    <td >
                                        <a href="admin/xoa_ycml.php?p=<?php echo $row['ID_HOCVIEN']; ?>"> Xóa </a>
                                    </td>
                                    <td >
                    ...
                    <nav style="text-align: center;">
                        <ul class="pagination">
                            ...
                            <li class="<?php if ($i >= $tongsotrang) echo 'disabled'; ?>">
                                <a href="index.php?p=2&i=<?php echo $i = $i + 5; //if ($i >= $tongsotrang){echo $i;} //else {echo $i = $i + 5;}      ?>&trang=<?php echo $i - 4; ?>"><span aria-hidden="true">&raquo;</span></a></li>
                        </ul>
                    </nav>
