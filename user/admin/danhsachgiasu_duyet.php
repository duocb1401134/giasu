<div class="outter-wp">
    ...
    <div class="sub-heard-part">
        <ol class="breadcrumb m-b-0">
            ...
            <li class="active">Danh Sách gia sư duyệt</li>
        </ol>
    </div>	
            ...
            <div class="inbox-right">
                <div class="mailbox-content">
                    <table class="table">
                        <tbody>
                            <?php
                            $select = "SELECT * FROM giasu INNER JOIN image ON giasu.ID_IMG = image.ID_IMG where DAXEM_GS='1' and DUYET_GS=0 order by ID_GS DESC";
